...
const projects = [
  {
    ...
    pdf: "/Proyecto gestion-logistica.pdf",
    ...
    images: [
      { src: "/gestion-logistica/adicionales.png", label: "Adicionales" },
      { src: "/gestion-logistica/clientes.png", label: "Clientes" },
      { src: "/gestion-logistica/destinos.png", label: "Destinos" },
      { src: "/gestion-logistica/documentacion.png", label: "Documentos" },
      { src: "/gestion-logistica/gastos.png", label: "Gastos" },
      { src: "/gestion-logistica/liquidaciones.png", label: "Liquidaciones" },
      { src: "/gestion-logistica/preliquidaciones.png", label: "Preliquidaciones" },
      { src: "/gestion-logistica/proveedores.png", label: "Proveedores" },
      { src: "/gestion-logistica/tarifas.png", label: "Tarifas" },
      { src: "/gestion-logistica/telegram.png", label: "Telegram" },
      { src: "/gestion-logistica/usuarios.png", label: "Usuarios" },
      { src: "/gestion-logistica/viajes.png", label: "Viajes" },
